...
\noindent\textbf{Type-Specific Corruptor:} The type-specific corruption tool is written in 455 lines of code, with less than 30 lines of code required for the main function of each file system. The structure that the user wants to corrupt is specified via the command line and the tool uses type introspection to find it.
