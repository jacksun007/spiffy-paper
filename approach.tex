...
specific B-trees and others can safely be ignored)
In contrast, a manually written application requires file-system specific code to traverse the file system, loading and validating data structures, and parsing directory entries before actually invoking any application-specific code, namely, recording the file name in the directory entry.
