...
Spiffy's backend generates {\color{red}C++ code for} a file-system specific metadata library using Jinja2~\cite{ronacher2011jinja2}.
...
The library can be compiled as either a user space library or as part of a Linux kernel module. {\color{red}We linked our module, including our generated library, into the Linux kernel by porting some C++ standard containers to the kernel environment and integrating the GNU g++ compiler into the kernel build process, which required minor changes.}
