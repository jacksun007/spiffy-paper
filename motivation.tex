...
\item Ext2/3/4 inodes contain union fields for storing operating system specific metadata. A sanity check was omitted in e2fsck prior to accessing this field, causing erroneous repairs to be performed when the creator OS is not Linux. Consequently, the file system becomes corrupted for Hurd and possibly other operating systems.
