...
pointed-to types and their when clauses. The \texttt{size} argument
...
Btrfs pointers have a raid address type. Later, in Section~\ref{sec:Implementation},
...
clause to point to all the different types of metadata objects that
...
The static metadata area consists of a pair of checkpoint packs, as shown in Figure \ref{fig:F2FS-checkpoint-packs}, and various look-up tables for space and pointer management.
